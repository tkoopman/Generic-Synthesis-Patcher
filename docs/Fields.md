...
| Factions                           |             | MFFSM | JSON objects containing item Form Key/Editor ID and Rank                                                                             | "Factions": { "Item": "021FED:Skyrim.esm", "Rank": 0 } |
...
| PlayerSkills                       |             | -FF-- | JSON object containing the values under PlayerSkills you want to set                                                                 | See ../Examples/NPC Player Skills.json                 |
| Race                               | RNAM        | MFF-- | Form Key or Editor ID                                                                                                                |                                                        |
| ShortName                          | ONAM        | MFF-- | String value                                                                                                                         | "ShortName": "Hello"                                   |
