...
namespace GenericSynthesisPatcher.Helpers
{
    public class RecordCallData<T> ( string propertyName ) : RecordCallData( propertyName ) where T : class, IAction
    {
        ...
        public override bool Forward ( IModContext<ISkyrimMod, ISkyrimModGetter, ISkyrimMajorRecord, ISkyrimMajorRecordGetter> context, IMajorRecordGetter? origin, GSPRule rule, IMajorRecordGetter forwardRecord, Helpers.RecordCallData rcd ) => T.Forward(context, origin, rule, forwardRecord, rcd);
    }
    public abstract class RecordCallData ( string propertyName )
    {
        ...
        public abstract bool Forward ( IModContext<ISkyrimMod, ISkyrimModGetter, ISkyrimMajorRecord, ISkyrimMajorRecordGetter> context, IMajorRecordGetter? origin, GSPRule rule, IMajorRecordGetter forwardRecord, RecordCallData rcd );
    }
}