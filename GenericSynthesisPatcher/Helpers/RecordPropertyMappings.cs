...
namespace GenericSynthesisPatcher.Helpers
{
    public static partial class RecordPropertyMappings
    {
        ...
        public static IReadOnlyList<string> GetNullAliases (string propertyName)
        {
...
#pragma warning disable format
            ...
            AddAlias(null                                 , "OBND.First"   , "ObjectBounds.First");
            AddAlias(null                                 , "OBND.First.X" , "ObjectBounds.First.X");
            AddAlias(null                                 , "OBND.First.Y" , "ObjectBounds.First.Y");
            AddAlias(null                                 , "OBND.First.Z" , "ObjectBounds.First.Z");
            AddAlias(null                                 , "OBND.Second"  , "ObjectBounds.Second");
            AddAlias(null                                 , "OBND.Second.X", "ObjectBounds.Second.X");
            AddAlias(null                                 , "OBND.Second.Y", "ObjectBounds.Second.Y");
            AddAlias(null                                 , "OBND.Second.Z", "ObjectBounds.Second.Z");
