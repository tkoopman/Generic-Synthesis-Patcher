...
namespace GenericSynthesisPatcher
{
    public partial class Program
    {
        ...
        public static async Task<int> Main (string[] args)
        {
            ...
            //TODO Add games x4
            return
                args.Contains("--GenerateDocoUnused", StringComparer.OrdinalIgnoreCase)
                    ? await SynthesisPipeline.Instance
                                    .AddPatch<ISkyrimMod, ISkyrimModGetter>(GenerateDoco.GenerateUnused, new PatcherPreferences { NoPatch = true })
                                    .AddPatch<IFallout4Mod, IFallout4ModGetter>(GenerateDoco.GenerateUnused, new PatcherPreferences { NoPatch = true })
                                    .AddPatch<IOblivionMod, IOblivionModGetter>(GenerateDoco.GenerateUnused, new PatcherPreferences { NoPatch = true })
                ...
                : args.Contains("--GenerateDoco", StringComparer.OrdinalIgnoreCase)
                    ? await SynthesisPipeline.Instance
                                    .AddPatch<ISkyrimMod, ISkyrimModGetter>(GenerateDoco.Generate, new PatcherPreferences { NoPatch = true })
                                    .AddPatch<IFallout4Mod, IFallout4ModGetter>(GenerateDoco.Generate, new PatcherPreferences { NoPatch = true })
                                    .AddPatch<IOblivionMod, IOblivionModGetter>(GenerateDoco.Generate, new PatcherPreferences { NoPatch = true })
                                    .SetAutogeneratedSettings(nickname: "Generic Synthesis Patcher Settings", path: "settings.json", out Global.settings)
                                    .SetTypicalOpen(GameRelease.SkyrimSE, "GenericSynthesisPatcher.esp")
                                    .Run(args)
